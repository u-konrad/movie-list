...
const history =useHistory()
  ...
  return (
    <Wrapper className='card rounded shadow p-3 mb-3' onClick={()=>history.push(`/${movie.id}`)}>
        ...
        <div className='col-7'>
          ...
          <p>{movie.genreList?.map(genre=> <span className='me-1'>{genres[genre.key]} {genre.key} </span>)}</p>
          </div>
    </Wrapper>
  )
}
